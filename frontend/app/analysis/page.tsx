...
const AnalysisResult = () => {
  ...
  const LAW_URLS: Record<string, string> = {
    ...
    HMK: "https://www.mevzuat.gov.tr/mevzuat?MevzuatNo=6100&MevzuatTur=1&MevzuatTertip=5",
    TMK: "https://www.mevzuat.gov.tr/mevzuat?MevzuatNo=4721&MevzuatTur=1&MevzuatTertip=5",
    TCK: "https://www.mevzuat.gov.tr/mevzuat?MevzuatNo=5237&MevzuatTur=1&MevzuatTertip=5",
    ISK: "https://www.mevzuat.gov.tr/mevzuat?MevzuatNo=4857&MevzuatTur=1&MevzuatTertip=5",
    SSGSSK:
  ...
  const dynamicLaws = analiz.mevzuat.map((m) => ({
    ...
    full: "",
    source: "mevzuat.gov.tr",
    sourceUrl: LAW_URLS[m.kod] || `https://www.mevzuat.gov.tr`,
                      ...
                      {expandedLaw === i && (
                        ...
                        >
                          ...
                          <div className="mt-3 flex items-center gap-1.5">
                            ...
                            <a
                              href={liveContent[i]?.url || law.sourceUrl}
                              target="_blank"
                              rel="noopener noreferrer"
                              onClick={(e) => e.stopPropagation()}
...
export default withAuth(AnalysisResult);
